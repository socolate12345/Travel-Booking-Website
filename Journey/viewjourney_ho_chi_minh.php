...
<div class="main-content">
    ...
    <div class="tour-container">
        <div class="tour-card">
            ...
            <div class="tour-details">
                <h3>Saigon City Tour - Duc Ba Church, NguyenHue Street, Landmark81,Bui Vien,Dinh Doc Lap 3 DAYS </h3>
                <ul>
                    <li><span class="icon">📅</span> 20/05 - 22/05, 27/05 - 29/05</li>
                    <li><span class="icon">📍</span> TP. Hồ Chí Minh</li>
                    <li><span class="icon">⏰</span> 3 Days</li>
                    <li><span class="icon">🚌</span> Bus + Walking Tour</li>
                </ul>
                <p class="price">3,600,000 ₫ <span class="original-price">4,000,000 ₫</span></p>
