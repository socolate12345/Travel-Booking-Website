...
<main>
    ...
    <div class="gallery">
        <div class="big"><img src="nhatrang3/1.jpg" alt="Big Image"></div>
        <div class="small1"><img src="nhatrang3/2.jpg" alt="Small 1"></div>
        <div class="small2"><img src="nhatrang3/3.jpg" alt="Small 2"></div>
        <div class="small3"><img src="nhatrang3/4.jpg" alt="Small 3"></div>
        <div class="small4"><img src="nhatrang3/5.jpg" alt="Small 4"></div>
    </div>
    ...
    <div class="content-columns">
        ...
        <div class="right-column">
            <div class="box3">
                ...
                <a href="../booktour.php?cityid=12&tourid=11" class="booking-button">Booking now!</a>
            </div>
            </div>
            <div class="box">
