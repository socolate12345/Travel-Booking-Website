        ...
        <div class="filter-box">
            <div class="custom-dropdown">
                ...
                <div id="regionDropdown" class="custom-dropdown-content">
                    ...
                    <label><input type="checkbox" name="region[]" value="North West" <?php if (in_array("North West", $selectedRegions)) echo "checked"; ?>>North West</label>
                    <label><input type="checkbox" name="region[]" value="South" <?php if (in_array("South", $selectedRegions)) echo "checked"; ?>>South</label>
                    <label><input type="checkbox" name="region[]" value="South East" <?php if (in_array("South East", $selectedRegions)) echo "checked"; ?>>South East</label>
                    <label><input type="checkbox" name="region[]" value="Central" <?php if (in_array("Central", $selectedRegions)) echo "checked"; ?>>Central</label>
                    <label><input type="checkbox" name="region[]" value="Mekong Delta" <?php if (in_array("Mekong Delta", $selectedRegions)) echo "checked"; ?>>Mekong Delta</label>
            ...
            <div class="custom-dropdown">
                ...
                <div id="daysDropdown" class="custom-dropdown-content">
                    ...
                    <label><input type="checkbox" name="days[]" value="2" <?php if (in_array("2", $selectedDays)) echo "checked"; ?>>2</label>
                    ...
                    <label><input type="checkbox" name="days[]" value="6" <?php if (in_array("6", $selectedDays)) echo "checked"; ?>>6</label>
...
<br>
    ...
    foreach ($data as $row) {
        ...
        echo "<td>" . $row["cost"] . "</td>";
        echo "<td>";
        echo "<a href='editcity.php?cityid=" . $row["cityid"] . "' class='edit-button'>Edit</a> | ";
        echo "<a href='?delete=" . $row["cityid"] . "' class='delete-button'>Delete</a>";
        echo "</td>";
